...
- [ ] **#21** Confirm what EC Nordic collects through CrewLAB and replace the placeholder `#improvement` `#ecnordic` *(2026-06-04)*
  The "For parents & supporters" section of `src/content/pages/crewlab.md` carries `[PLACEHOLDER: confirm what EC Nordic collects through CrewLAB, whether camp cost-share, dues, or donations.]`. Decide what the program actually collects through the app, then replace the placeholder with the real answer before publish.
