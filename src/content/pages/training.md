...
A lake cabin near Talkeetna. Twice-a-day training, plus the lake and a sauna. Its own registration.
:::
::::
...
Everyone trains as one team, and we split into three groups by experience and pace. We set each group's workouts and weekly load to fit its athletes, so they grow without overtraining or overuse injuries.
...
Wherever you start, you are not left to keep up, and you are not held back.
...
A signed liability waiver has to be on file before your first session. You sign it in [CrewLAB](cairn:pages/crewlab), and only there.
...
The camp is free, with donations requested according to what your family can manage. Camp registration and consent are their own forms, separate from summer-training registration, and both are handled in CrewLAB. The exact site and address go to registered families in CrewLAB.
